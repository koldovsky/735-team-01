(function () {
    ...
    const coursesSlides = [
        `<div class="slider-item__coureses active">
            <img class="img__courses" width="50" src="img/coffee-courses.png">
        ...
        `<div class="slider-item__coureses active">
            <img class="img__courses" width="50" src="img/time-a-coffee.png">
        ...
        `<div class="slider-item__coureses active">
            <img class="img__courses" width="50" src="img/making-coffee.png">
        ...
        `<div class="slider-item__coureses active">
            <img class="img__courses" width="50" src="img/type-of-coffee.png">
